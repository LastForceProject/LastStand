class Curators
{
	list[] = 
	{
		...
		,"76561198121927537"//Morket (SudoCurator)
		...
		,"76561198817496048"//Jind(Event)
		,"76561198168577214"//Wolf (Event)
        ,"76561198033904243"//Jisai (Donate_Zeus)
		,"76561198195478551"//Mergen (NeutralCurator)
		,"76561198227583576"//Filin (EventNeutral)
		,"76561198403064350"//Smetanka (EventNeutral)
		,"76561198114414576"//Auberon fon Thorne(JediCurator)
        ,"76561198084192447"//Irai(EventJedi)
		,"76561198253231135"//BKA (EventJedi)
		,"76561198102983006"//Joker (Gray)
        ,"76561198351130485"//Bybylyka (Gray)
		,"76561198006688545"//Dark (BSO)
        ,"76561198053534432"//Redcrown(Rp)        	
	};
};
