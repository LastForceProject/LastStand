...
force force ace_common_checkPBOsWhitelist = "['WebKnight_StarWars_Gundone','SWOP_arc170','zeus_lfp','zbe_cache','asn_core','lwscripts','SWCMS','LS_clones_mg_Z6','asn_key','ASN_WikiPages','pja306','gge_core','gge_nvganim','gge_captives','PLP_MapTools','PLP_Kompass','DFS_3rdPerson','asw_main','ANZ_MissileEfxMod','WarFXPE','Blastcore_MainCore','Blastcore_VEP','jsrs_soundmod_complete_edition','jsrs_soundmod_boats','jsrs_soundmod_sonic_cracks','jsrs_soundmod_weapons','jsrs_soundmod_environment','jsrs_soundmod_explosions','jsrs_soundmod_framework','jsrs_soundmod_landvehicles','jsrs_soundmod_movement','jsrs_soundmod_bullethits','jsrs_soundmod_helicopters','jsrs_soundmod_complete_edition_soundfiles','212_Legion','asn_achies','extdb3','ServerLocker','Locker','HashCode_Locker','HashCodeServer_Locker','sw_panel','safecode']";
