...
force force ace_common_checkPBOsWhitelist = "['WebKnight_StarWars_Gundone','SWOP_arc170','zeus_lfp','zbe_cache','asn_core','lwscripts','SWCMS','LS_clones_mg_Z6','asn_key','ASN_WikiPages','pja306','gge_core','gge_nvganim','gge_captives','PLP_MapTools','PLP_Kompass','DFS_3rdPerson','asw_main','ANZ_MissileEfxMod','WarFXPE','Blastcore_MainCore','Blastcore_VEP','jsrs_soundmod_complete_edition','jsrs_soundmod_boats','jsrs_soundmod_sonic_cracks','jsrs_soundmod_weapons','jsrs_soundmod_environment','jsrs_soundmod_explosions','jsrs_soundmod_framework','jsrs_soundmod_landvehicles','jsrs_soundmod_movement','jsrs_soundmod_bullethits','jsrs_soundmod_helicopters','jsrs_soundmod_complete_edition_soundfiles','212_Legion','asn_achies','extdb3','ServerLocker','Locker','HashCode_Locker','HashCodeServer_Locker','sw_panel','safecode','zen_main','zen_common','zen_context_menu','zen_dialog','zen_editor','zen_editor_previews','zen_flashlight','zen_markers_tree','zen_music','zen_placement','zen_position_logics','zen_visibility','zen_vision','zen_ai','zen_attributes','zen_camera','zen_compositions','zen_damage','zen_garage','zen_iventory','zen_loadout','zen_modules','achilles_data_f_ares','achilles_language_f','achilles_data_f_achilles','achilles_functions_f_ares','achilles_functions_f_achilles','achilles_modules_f_ares','achilles_settings_f','achilles_ui_f','achilles_modules_f_achilles','AchillesEffects']";
