class Curators
{
	list[] = 
	{
        ...
        ,"76561198166050664"//Foxxy (Curator_Event v2.0) Чел не понимающий рофлов,привет от детей в муте.
        ...
        ,"76561198102124936"//Gutz(Event)
        ,"76561198308824143"//Кодич (Event)
        ,"76561198202985586"//Рик (Event)
        ,"76561198160789056"//Nero (Event)
		,"76561198375818840"//Solus (Event)
